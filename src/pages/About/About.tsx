    ...
    <ContentBox>
      ...
      <Section>
        <p>
          ...
          <a href="https://aws.amazon.com/image-builder/">EC2 Image Builder</a>{' '}
          team.
        </p>
      </Section>
      <Section>
        ...
        <p>
          ...
          making intuitive, responsive, and accessible experiences for users. My
          understanding of both front-end and back-end allows me to bridge the
          gap between design and functionality to deliver dynamic, efficient and
          scalable solutions. In addition to web development, I enjoy increasing
          developer efficiency, tackling complex issues in fast-paced
          environments, and collaborating with teammates while staying
          up-to-date on the latest trends and standards.
        </p>
        <p>
      ...
      <Section>
        ...
        <p>
          I have a passion for creativity and enjoy experimenting with different
          hobbies. Some of my favorites are laser crafting, stained glass, and
